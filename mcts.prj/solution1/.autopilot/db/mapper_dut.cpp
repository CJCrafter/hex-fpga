...
auto* sstrm_in = createStream((hls::stream<int>*)__xlx_apatb_param_strm_in);
...
auto* sstrm_out = createStream((hls::stream<int>*)__xlx_apatb_param_strm_out);
  // DUT call
  dut(sstrm_in->data<int>(), sstrm_out->data<int>());
sstrm_in->transfer((hls::stream<int>*)__xlx_apatb_param_strm_in);
sstrm_out->transfer((hls::stream<int>*)__xlx_apatb_param_strm_out);
}
