...
// wrapc file define:
#define AUTOTB_TVIN_strm_in "../tv/cdatafile/c.dut.autotvin_strm_in.dat"
#define WRAPC_STREAM_SIZE_IN_strm_in "../tv/stream_size/stream_size_in_strm_in.dat"
#define WRAPC_STREAM_INGRESS_STATUS_strm_in "../tv/stream_size/stream_ingress_status_strm_in.dat"
#define AUTOTB_TVOUT_strm_out "../tv/cdatafile/c.dut.autotvout_strm_out.dat"
#define WRAPC_STREAM_SIZE_OUT_strm_out "../tv/stream_size/stream_size_out_strm_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_strm_out "../tv/stream_size/stream_egress_status_strm_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_strm_out "../tv/rtldatafile/rtl.dut.autotvout_strm_out.dat"
...
extern "C"
void dut_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_dut_hw(void* __xlx_apatb_param_strm_in, void* __xlx_apatb_param_strm_out)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "strm_in",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_strm_in),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_strm_in),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_strm_in),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_strm_in),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_strm_in;
  ...
  static hls::sim::Stream<hls::sim::Byte<4>> port1 {
    ...
    .name = "strm_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_strm_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_strm_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_strm_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_strm_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_strm_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    dut_hw_stub_wrapper(__xlx_apatb_param_strm_in, __xlx_apatb_param_strm_out);
    port1.buffer();
