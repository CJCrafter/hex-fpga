...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_bitselect_1ns_49ns_6ns_1_1_1 BINDTYPE {op} TYPE {bitselect} IMPL {auto}
}
...
eval "cg_default_interface_gen_dc { \
    id 73 \
    name numLegalActions_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_numLegalActions_out \
    op interface \
    ports { numLegalActions_out { O 32 vector } numLegalActions_out_ap_vld { O 1 bit } } \
} "
}
