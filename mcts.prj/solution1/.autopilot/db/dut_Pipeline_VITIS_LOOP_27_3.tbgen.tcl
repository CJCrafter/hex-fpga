set moduleName dut_Pipeline_VITIS_LOOP_27_3
set isTopModule 0
...
set cdfgNum 24
set C_modelName {dut_Pipeline_VITIS_LOOP_27_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ strm_in int 32 regular {fifo 0 volatile }  }
	{ player2_out int 49 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "strm_in", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "player2_out", "interface" : "wire", "bitwidth" : 49, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ player2_out sc_out sc_lv 49 signal 1 } 
	{ player2_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "player2_out", "direction": "out", "datatype": "sc_lv", "bitwidth":49, "type": "signal", "bundle":{"name": "player2_out", "role": "default" }} , 
 	{ "name": "player2_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "player2_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	player2_out { ap_vld {  { player2_out out_data 1 49 }  { player2_out_ap_vld out_vld 1 1 } } }
}
