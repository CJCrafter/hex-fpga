...
dict set ap_memory_interface_dict this_firstChilds { MEM_WIDTH 32 MEM_SIZE 20400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict this_numChildren { MEM_WIDTH 32 MEM_SIZE 20400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
dict set ap_memory_interface_dict this_triedMask { MEM_WIDTH 49 MEM_SIZE 35700 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
set C_modelArgList {
	...
	{ this_nextFree_read int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "this_visitCounts", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "this_nextFree_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ this_nextFree_read sc_in sc_lv 32 signal 12 } 
	{ this_rng_read sc_in sc_lv 64 signal 13 } 
	{ gameState_legalActionMap sc_in sc_lv 49 signal 14 } 
	{ gameState_hexGame_isPlayer1Turn_s sc_in sc_lv 1 signal 15 } 
	{ gameState_hexGame_lastMove_s sc_in sc_lv 32 signal 16 } 
	{ gameState_hexGame_player1_s sc_in sc_lv 49 signal 17 } 
	{ gameState_hexGame_player2_s sc_in sc_lv 49 signal 18 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "this_nextFree_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "this_nextFree_read", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	this_nextFree_read { ap_none {  { this_nextFree_read in_data 0 32 } } }
